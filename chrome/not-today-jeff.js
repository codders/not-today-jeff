...
function updateTimer() {
  if (startDate > new Date() && startDate < endDate) {
    ...
    timer.innerHTML = "";
    timer.appendChild(document.createTextNode(countdown + " until the next "));
    var link = document.createElement("a");
    link.textContent = "global Amazon strike";
    link.setAttribute("href", "https://nottodayjeff.codders.io");
